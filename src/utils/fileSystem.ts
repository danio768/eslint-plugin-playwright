...
/**
 * Recursively searches for .spec.ts files in a directory. Uses the actual
 * project depth for optimal scanning.
 */
...
/**
 * Internal helper function that recursively scans directories for .spec.ts
 * files. Modifies the files array in-place by adding found spec file paths.
 *
