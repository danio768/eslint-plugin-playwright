...
| [no-duplicate-tags](https://github.com/playwright-community/eslint-plugin-playwright/tree/main/docs/rules/no-duplicate-tags.md)                     | Disallow duplicate `@number` tags across test files                                                         |     |     |     |
...
| [require-test-tags](https://github.com/playwright-community/eslint-plugin-playwright/tree/main/docs/rules/require-test-tags.md)                     | Require tests to have tags from configured tag pools with optional exclude patterns and granular validation |     |     |     |
